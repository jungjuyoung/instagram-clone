...
export default function UserCard({
  ...
  return (
    <Link
      href={`/user/${username}`}
      className="flex items-center w-full rounded-md border border-neutral-300 mb-2 p-4 bg-white hover:bg-neutral-50"
    >
      <Avatar image={image} username={username} highlight />
